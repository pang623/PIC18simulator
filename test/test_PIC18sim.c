...
void test_add_given_0x1C_and_0xFE_expect_N0_OV0_Z0_DC1_C1() {
  status = STATUS_N | STATUS_Z |STATUS_OV;
  int val = add(0x1C, 0xFE);
  TEST_ASSERT_EQUAL(val, 0x1C + 0xFE);
...
void test_add_given_0x84_and_0x79_expect_N1_OV0_Z0_DC0_C0() {
  ...
  TEST_ASSERT_EQUAL(val, 0x84 + 0x79);
...
void test_add_given_0x7C_and_0x64_expect_N1_OV1_Z0_DC1_C0() {
  ...
  TEST_ASSERT_EQUAL(val, 0x7C + 0x64);
...
void test_add_given_0x80_and_0x80_expect_N0_OV1_Z1_DC0_C1() {
  ...
  TEST_ASSERT_EQUAL(val, 0x80 + 0x80);
...
void test_add_given_0x00_and_0x00_expect_N0_OV0_Z1_DC0_C0() {
  ...
  TEST_ASSERT_EQUAL(val, 0x00 + 0x00);
...
void test_executeInstruction_given_0x2645_expect_addwf_called_and_access_to_0x45_with_the_result_stored_in_fileRegister(void) {
  ...
  executeInstruction(codeMemory);       //if is array, its passing in array address
...
void test_executeInstruction_given_0x2667_expect_addwf_called_and_access_to_0xf67_with_the_result_stored_in_fileRegister(void) {
  ...
  //Run the code under test
  executeInstruction(codeMemory);       //if is array, its passing in array
  //Verify the code has expected output
...
void test_executeInstruction_given_0x2A10_expect_incf_called(void) {
  //Setup test fixture
...
void test_executeInstruction_given_0x284D_expect_incf_called(void) {
  //Setup test fixture
...
void test_executeInstruction_given_0x2AA9_expect_incf_called(void) {
  //Setup test fixture
...
void test_executeInstruction_given_0x28CD_expect_incf_called(void) {
  //Setup test fixture
...
void test_executeInstruction_given_0x2B38_expect_incf_called(void) {
  //Setup test fixture
...
void test_executeInstruction_given_0x29FF_expect_incf_called(void) {
  //Setup test fixture
...
void test_executeInstruction_given_0x6A2E_expect_clrf_called(void) {
  //Setup test fixture
  ...
  TEST_ASSERT_EQUAL_HEX8(0x33, fileRegisters[0x12E]);
  TEST_ASSERT_EQUAL_HEX8(0x44, fileRegisters[0xF2E]);
  TEST_ASSERT_EQUAL_HEX8(0x1F, wreg);
  TEST_ASSERT_EQUAL_HEX8(STATUS_Z, status);
}

//  0110 101a ffff ffff
//clrf   0x9F, ACCESS   ==> 0110 1010 1001 1111(0x6A9F)
void test_executeInstruction_given_0x6A9F_expect_clrf_called(void) {
  //Setup test fixture
...
//  0110 101a ffff ffff
//clrf   0xE8, BANKED   ==> 0110 1011 1110 1000(0x6BE8)
void test_executeInstruction_given_0x6B28_expect_clrf_called(void) {
  //Setup test fixture
  uint8_t codeMemory[] = {0x28, 0x6B, 0x00, 0xff};
  //Set BSR
  bsr = 0xA;
  //Set WREG
  wreg = 0x12;
  //Set content of target file reg
  fileRegisters[0x28]  = 0x11;
  fileRegisters[0xA28] = 0x23;
  fileRegisters[0xF28] = 0x55;
  //Clear the status register for testing
  status = 0x00;
  //Run the code under test
  executeInstruction(codeMemory);       //if is array, its passing in array
  //Verify the code has expected output
  TEST_ASSERT_EQUAL_HEX8(0x00, fileRegisters[0xA28]);
  TEST_ASSERT_EQUAL_HEX8(0x11, fileRegisters[0x28]);
  TEST_ASSERT_EQUAL_HEX8(0x55, fileRegisters[0xF28]);
...
//bit set 0 ==> 1
void test_executeInstruction_given_0x8A3A_expect_bsf_called(void) {
  //Setup test fixture
  ...
  TEST_ASSERT_EQUAL_HEX8(0x33, fileRegisters[0x43A]);
...
//bit set 1 ==> 1
void test_executeInstruction_given_0x8205_expect_bsf_called(void) {
  //Setup test fixture
...
//bit set 0 ==> 1
void test_executeInstruction_given_0x8EA0_expect_bsf_called(void) {
  //Setup test fixture
...
//bit set 1 ==> 1
void test_executeInstruction_given_0x80DC_expect_bsf_called(void) {
  //Setup test fixture
...
//bit set 0 ==> 1
void test_executeInstruction_given_0x8D9A_expect_bsf_called(void) {
  //Setup test fixture
...
//bit set 1 ==> 1
void test_executeInstruction_given_0x87BD_expect_bsf_called(void) {
  //Setup test fixture
...
//bit clr 1 ==> 0
void test_executeInstruction_given_0x9856_expect_bcf_called(void) {
  //Setup test fixture
...
//bit clr 0 ==> 0
void test_executeInstruction_given_0x9A4F_expect_bcf_called(void) {
  //Setup test fixture
...
//bit clr 1 ==> 0
void test_executeInstruction_given_0x9478_expect_bcf_called(void) {
  //Setup test fixture
...
//bit clr 0 ==> 0
void test_executeInstruction_given_0x96FA_expect_bcf_called(void) {
  //Setup test fixture
...
//bit clr 1 ==> 0
void test_executeInstruction_given_0x9F37_expect_bcf_called(void) {
  //Setup test fixture
...
//bit clr 0 ==> 0
void test_executeInstruction_given_0x93BE_expect_bcf_called(void) {
  //Setup test fixture
...
void test_executeInstruction_given_0x6E16_expect_movwf_called(void) {
  //Setup test fixture
  ...
  TEST_ASSERT_EQUAL_HEX8(0X00, fileRegisters[0x716]);
  TEST_ASSERT_EQUAL_HEX8(0X00, fileRegisters[0xF16]);
  TEST_ASSERT_EQUAL_HEX8(0x5A, wreg);
}

//movwf   0xB9, ACCESS   ==> 0110 1110 1011 1001(0x6EB9)
void test_executeInstruction_given_0x6EB9_expect_movwf_called(void) {
  //Setup test fixture
...
void test_executeInstruction_given_0x6FEA_expect_movwf_called(void) {
  //Setup test fixture
...
void test_executeInstruction_given_0x1602_expect_andwf_called(void) {
  //Setup test fixture
  ...
  TEST_ASSERT_EQUAL_HEX8(0xFF, fileRegisters[0xC02]);
  TEST_ASSERT_EQUAL_HEX8(0xFF, fileRegisters[0xF02]);
  TEST_ASSERT_EQUAL_HEX8(0x9E, wreg);
  TEST_ASSERT_EQUAL_HEX8(STATUS_N, status);
}

//  0001 01da ffff ffff
//andwf   0x5F, w, ACCESS   ==> 0001 0100 0101 1111(0x145F)
void test_executeInstruction_given_0x145F_expect_andwf_called(void) {
  //Setup test fixture
  ...
  executeInstruction(codeMemory);       //if is array, its passing in array
  //Verify the code has expected output
  TEST_ASSERT_EQUAL_HEX8(0x7C, fileRegisters[0x5F]);
...
void test_executeInstruction_given_0x1688_expect_andwf_called(void) {
  //Setup test fixture
...
void test_executeInstruction_given_0x14FF_expect_andwf_called(void) {
  //Setup test fixture
...
void test_executeInstruction_given_0x1700_expect_andwf_called(void) {
  //Setup test fixture
...
void test_executeInstruction_given_0x1548_expect_andwf_called(void) {
  //Setup test fixture
...
void test_executeInstruction_given_0x3630_expect_rlcf_called(void) {
  //Setup test fixture
  ...
  TEST_ASSERT_EQUAL_HEX8(0x12, fileRegisters[0xA30]);
...
void test_executeInstruction_given_0x344F_expect_rlcf_called(void) {
  //Setup test fixture
  ...
  executeInstruction(codeMemory);
  //Verify the code has expected output
  TEST_ASSERT_EQUAL_HEX8(0x17, fileRegisters[0x4F]);
...
void test_executeInstruction_given_0x3668_expect_rlcf_called(void) {
  //Setup test fixture
...
void test_executeInstruction_given_0x34F3_expect_rlcf_called(void) {
  //Setup test fixture
...
void test_executeInstruction_given_0x376D_expect_rlcf_called(void) {
  //Setup test fixture
...
void test_executeInstruction_given_0x3523_expect_rlcf_called(void) {
  //Setup test fixture
...
void test_executeInstruction_given_0x3700_expect_rlcf_called(void) {
  //Setup test fixture
